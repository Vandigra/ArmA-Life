...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe", "huntingKit","toolbox","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","rabbit_raw","hen_raw","rooster_raw","sheep_raw","goat_raw", "rubbellos",
    "qua_lenker", "qua_sitzbank", "qua_felge", "qua_gepaeck_vorne", "qua_gepaeck_hinten", "qua_bremsscheibe", "qua_bremsklotz", "qua_lenkachse", "qua_federung", "qua_getriebe", "qua_ruecklicht_links", "qua_ruecklicht_rechts", "qua_frontlicht_links", "qua_frontlicht_rechts", "qua_tank", "qua_kuehlergrill", "qua_kuehler", "qua_zylinder", "qua_zuendkerze", "hatch_lenkrad", "hatch_rueckbank", "hatch_sitz_vorne",
    "hatch_motorhaube", "hatch_bremsscheibe", "hatch_bremsklotz", "hatch_lenkachse", "hatch_federung", "hatch_getriebe", "hatch_ruecklicht_links", "hatch_ruecklicht_rechts", "hatch_frontlicht_links", "hatch_frontlicht_rechts", "hatch_tank", "hatch_kuehlergrill", "hatch_kuehler", "hatch_Zylinder", "hatch_zuendkerze", "hatch_Kofferraum", "hatch_stossfaenger_vorne", "hatch_stossfaenger_hinten", "hatch_rueckspiegel",
    "hatch_aussenspiegel", "hatch_katalysator", "hatch_endtopf", "hatch_felge", "hatch_frontscheibe", "hatch_seitenscheibe", "hatch_dachscheibe", "hatch_schaltung", "Hatch_pedal_gas", "hatch_pedal_bremse", "hatch_pedal_kupplung", "hatch_tuergriff", "hatch_tuer_vorne_links", "hatch_tuer_vorne_rechts", "hatch_tuer_hinten_links", "hatch_tuer_hinten_rechts", "off_lenkrad", "off_sitz", "off_motorhaube", "off_bremsscheibe",
    "off_bremsklotz", "off_lenkachse", "off_federung", "off_getriebe", "off_ruecklicht_links", "off_ruecklicht_rechts", "off_frontlicht_links", "off_frontlicht_rechts", "off_tank", "off_kuehlergrill", "off_kuehler", "off_zylinder", "off_zuendkerze", "off_kofferaum", "off_stossfaenger_vorne", "off_stossfaenger_hinten", "off_rueckspiegel", "off_aussenspiegel", "off_katalysator", "off_endtopf", "off_felge", "off_frontscheibe",
    "off_seitenscheibe", "off_heckscheibe", "off_schaltung", "off_pedal_gas", "off_pedal_bremse", "off_pedal_kupplung", "off_tuergriff", "off_tuer_links", "off_tuer_rechts", "suv_lenkrad", "suv_rueckbank", "suv_sitz_vorne", "suv_motorhaube", "suv_bremsscheibe", "suv_bremsklotz", "suv_lenkachse", "suv_federung", "suv_getriebe", "suv_ruecklicht_links", "suv_ruecklicht_rechts", "suv_frontlicht_links", "suv_frontlicht_rechts",
    "suv_tank", "suv_kuehlergrill", "suv_kuehler", "suv_zylinder", "suv_zuendkerze", "suv_kofferraum", "suv_stossfaenger_vorne", "suv_stossfaenger_hinten", "suv_rueckspiegel", "suv_aussenspiegel_links", "suv_aussenspiegel_rechts", "suv_katalysator", "suv_endtopf", "suv_felge", "suv_frontscheibe", "suv_seitenscheibe", "suv_heckscheibe", "suv_dachscheibe", "suv_schaltung", "suv_pedal_gas", "suv_pedal_bremse",
    "suv_pedal_kupplung", "suv_tuergriff", "suv_tuer_links", "suv_tuer_rechts", "kart_lenkrad", "kart_sitz", "kart_felge", "kart_bremsscheibe", "kart_bremsklotz", "kart_lenkachse", "kart_tank", "kart_getriebe", "kart_kuehler", "kart_katalysator", "kart_endtopf", "kart_zylinder", "kart_zuendkerze", "kart_stossfaenger_vorne", "kart_stossfaenger_hinten", "off2_lenkrad", "off2_sitz", "off2_motorhaube", "off2_bremsscheibe",
    "off2_bremsklotz", "off2_lenkachse", "off2_federung", "off2_getriebe", "off2_ruecklicht_links", "off2_ruecklicht_rechts", "off2_frontlicht_links", "off2_frontlicht_rechts", "off2_tank", "off2_kuehlergrill", "off2_kuehler", "off2_zylinder", "off2_zuendkerze", "off2_kofferaum", "off2_stossfaenger_vorne", "off2_stossfaenger_hinten", "off2_rueckspiegel", "off2_aussenspiegel", "off2_katalysator", "off2_endtopf",
    "off2_felge", "off2_frontscheibe", "off2_seitenscheibe", "off2_heckscheibe", "off2_schaltung", "off2_pedal_gas", "off2_pedal_bremse", "off2_pedal_kupplung", "off2_tuergriff", "off2_tuer_links", "off2_tuer_rechts" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "pickaxe", "huntingKit","toolbox","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","rabbit_raw","hen_raw","rooster_raw","sheep_raw","goat_raw", "rubbellos",
    "qua_lenker", "qua_sitzbank", "qua_felge", "qua_gepaeck_vorne", "qua_gepaeck_hinten", "qua_bremsscheibe", "qua_bremsklotz", "qua_lenkachse", "qua_federung", "qua_getriebe", "qua_ruecklicht_links", "qua_ruecklicht_rechts", "qua_frontlicht_links", "qua_frontlicht_rechts", "qua_tank", "qua_kuehlergrill", "qua_kuehler", "qua_zylinder", "qua_zuendkerze", "hatch_lenkrad", "hatch_rueckbank", "hatch_sitz_vorne",
    "hatch_motorhaube", "hatch_bremsscheibe", "hatch_bremsklotz", "hatch_lenkachse", "hatch_federung", "hatch_getriebe", "hatch_ruecklicht_links", "hatch_ruecklicht_rechts", "hatch_frontlicht_links", "hatch_frontlicht_rechts", "hatch_tank", "hatch_kuehlergrill", "hatch_kuehler", "hatch_Zylinder", "hatch_zuendkerze", "hatch_Kofferraum", "hatch_stossfaenger_vorne", "hatch_stossfaenger_hinten", "hatch_rueckspiegel",
    "hatch_aussenspiegel", "hatch_katalysator", "hatch_endtopf", "hatch_felge", "hatch_frontscheibe", "hatch_seitenscheibe", "hatch_dachscheibe", "hatch_schaltung", "Hatch_pedal_gas", "hatch_pedal_bremse", "hatch_pedal_kupplung", "hatch_tuergriff", "hatch_tuer_vorne_links", "hatch_tuer_vorne_rechts", "hatch_tuer_hinten_links", "hatch_tuer_hinten_rechts", "off_lenkrad", "off_sitz", "off_motorhaube", "off_bremsscheibe",
    "off_bremsklotz", "off_lenkachse", "off_federung", "off_getriebe", "off_ruecklicht_links", "off_ruecklicht_rechts", "off_frontlicht_links", "off_frontlicht_rechts", "off_tank", "off_kuehlergrill", "off_kuehler", "off_zylinder", "off_zuendkerze", "off_kofferaum", "off_stossfaenger_vorne", "off_stossfaenger_hinten", "off_rueckspiegel", "off_aussenspiegel", "off_katalysator", "off_endtopf", "off_felge", "off_frontscheibe",
    ...
    "suv_pedal_kupplung", "suv_tuergriff", "suv_tuer_links", "suv_tuer_rechts", "kart_lenkrad", "kart_sitz", "kart_felge", "kart_bremsscheibe", "kart_bremsklotz", "kart_lenkachse", "kart_tank", "kart_getriebe", "kart_kuehler", "kart_katalysator", "kart_endtopf", "kart_zylinder", "kart_zuendkerze", "kart_stossfaenger_vorne", "kart_stossfaenger_hinten", "off2_lenkrad", "off2_sitz", "off2_motorhaube", "off2_bremsscheibe",
    "off2_bremsklotz", "off2_lenkachse", "off2_federung", "off2_getriebe", "off2_ruecklicht_links", "off2_ruecklicht_rechts", "off2_frontlicht_links", "off2_frontlicht_rechts", "off2_tank", "off2_kuehlergrill", "off2_kuehler", "off2_zylinder", "off2_zuendkerze", "off2_kofferaum", "off2_stossfaenger_vorne", "off2_stossfaenger_hinten", "off2_rueckspiegel", "off2_aussenspiegel", "off2_katalysator", "off2_endtopf",
    "off2_felge", "off2_frontscheibe", "off2_seitenscheibe", "off2_heckscheibe", "off2_schaltung", "off2_pedal_gas", "off2_pedal_bremse", "off2_pedal_kupplung", "off2_tuergriff", "off2_tuer_links", "off2_tuer_rechts" }; //Array of virtual items that can be saved on your vehicle.
...
/* System Settings */
    ...
    cop_news_broadcast_cooldown = 2; // Abklingzeit zwischen zwei Nachrichten der Polizei
    cop_news_broadcast_minimum_Rank = 2; // Benötigter Rang der Polizisten, um Nachrichten zu senden
    reb_news_broadcast_cooldown = 5; // Cooldown für das Bedrohen (default 15)
    ...
    vehicle_impound_fee_multiplier = .4; //Pull from impound Garaqge cost --> Cost takes the playersides Buy Price * multiplier
