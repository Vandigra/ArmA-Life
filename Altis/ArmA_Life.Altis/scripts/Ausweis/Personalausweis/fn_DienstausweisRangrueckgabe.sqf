...
_Rueckgabe = switch (side _Spieler) do {
	case west: {
		switch _Level do {
			case 1: { ["Polizeianwärter",_Level,COP_BILD_DIENST,_Lizenz] };
			case 2: { ["Polizeimeisteranwärter",_Level,COP_BILD_DIENST,_Lizenz] };
			case 3: { ["Polizeimeister",_Level,COP_BILD_DIENST,_Lizenz] };
			case 4: { ["Polizeiobermeister",_Level,COP_BILD_DIENST,_Lizenz] };
			case 5: { ["Polizeikommissar",_Level,COP_BILD_DIENST,_Lizenz] };
			case 6: { ["Polizeioberkommissar",_Level,COP_BILD_DIENST,_Lizenz] };
			case 7: { ["Polizeihauptkommissar",_Level,COP_BILD_DIENST,_Lizenz] };
