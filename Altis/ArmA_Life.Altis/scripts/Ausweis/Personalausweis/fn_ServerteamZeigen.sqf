...
[
    ...
    [format["Dir wird gerade der Serverteamausweis von %1 gezeigt. Dieser Ausweis ist gültig. Befolge entsprechend deren Anweisungen.<br/>Blende diesen mit Zirkumflex (^) wieder aus.<br/><br/>Falls der Hotkey nicht funktioniert, siehe in dein Scrollmenue.",_Profilname],[1,0,0,1],[0,0,0,0.5]],
    ["",[0,0,0,0.5]],
    10,
    (1-0.165),
    0.165,
