class Dialog_PersonalausweisErstellenVorschau {
	...
	class controls {
		...
		{
			idc = 1200;
			text = "textures\Ausweis\Personalausweis.paa";
		...
		class Knopf_Beantragen: Life_RscButtonMenu
		{
			...
			idc = 2400;
			text = "PERSONALAUSWEIS BEANTRAGEN"; //--- ToDo: Localize;
			x = 0.510312 * safezoneW + safezoneX;
			y = 0.742 * safezoneH + safezoneY;
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			colorBackground[] = {0,0.6,0,1};
			tooltip = "Mit dem Klicken auf diesen Knopf wird der Personalausweis beantragt und angelegt."; //--- ToDo: Localize;
		};
		...
		{
			idc = 1001;
			text = "Ausweisnummer"; //--- ToDo: Localize;
		...
		{
			idc = 1002;
			text = "Ausstelldatum"; //--- ToDo: Localize;
			sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
