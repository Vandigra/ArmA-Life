...
*/
if (!(isNull (uiNameSpace getVariable "ui_Dienstausweis"))) exitWith {hint "Jemand hat wollte dir seinen Personalausweis zeigen, jedoch schaust du dir gerade einen an. Blende diesen erst aus.";};
...
if !(_Spieler isEqualTo player) then {
	[
		...
		[format["Du schaust dir gerade den Dienstausweis von %1 an.<br/><br/>Falls der Hotkey nicht funktioniert, siehe in dein Scrollmenue.",_Spielername,_TasteAusblendenName],[1,0,0,1],[0,0,0,0.5]],
		["",[0,0,0,0.5]],
		10,
		(1-0.165),
		0.165,
	...
	[
		["",[0,0,0,0.5]],
		[0.022,[(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843]),(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019]),(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862]),0.5]],
		[format["Du schaust die gerade den Personalausweis von dir selber an. Blende diesen wieder mit '%1' aus.<br/><br/>Falls der Hotkey nicht funktioniert, siehe in dein Scrollmenue.",_TasteAusblendenName],[1,0,0,1],[0,0,0,0.5]],
		["",[0,0,0,0.5]],
		10,
		(1-0.165),
		0.165,
